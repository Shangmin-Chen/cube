...
- Keep canonical living specs (`current-state.md`, `architecture.md`) accurate to verified, shipped reality; update them upon completion during Phase 4 rather than pre-populating them with unverified intent.
...
- Orchestrators must direct subagents to the recorded plan and relevant specs before implementation begins.
- Subagents must treat the recorded plan as their authoritative contract and definition of done.
