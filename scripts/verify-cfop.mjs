...
async function runVerification() {
  ...
  // 4. Probability convention: each 2-look sub-step's case probabilities plus its
  ...
  console.log(`✓ Invariant 4: every 2-look sub-step plus its skip sums to 1 — ${SUB_STEP_SUMMARY}`);

  // 5. Guard retained from the original AC: no case may display a probability whose
  ...
  console.log('✓ Invariant 5: no 2-look case displays a probability from another deck\'s denominator');
